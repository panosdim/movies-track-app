...
# Log the Kafka configuration
_logger.info(
    f"Kafka configuration - Bootstrap Servers: {KAFKA_BOOTSTRAP_SERVERS}, Topic: {KAFKA_TOPIC}"
)
...
def get_suggestions_cache(user_id: str) -> Optional[List]:
